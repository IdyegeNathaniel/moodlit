...
const BookCard = ({ mood, onClick }: BookCardProps) => {
  return (
    <div
      onClick={onClick}
    ...
    >
      <div className="items-center space-y-3">
        <div className="text-5xl group-hover:scale-105 transition duration-300">
          {mood.icon}
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <span
            className="opacity-0 group-hover:opacity-100 w-2 h-2 rounded-xl z-1  transition-colors duration-300"
